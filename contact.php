			...
			<div class="row">
				...
				<div class="col-lg-8 contact_col">
					<div class="get_in_touch">
						<div class="section_title">Сделать запрос</div>						
						<div class="contact_form_container">
							<form action="" method="post" target="_blank"   id="contact_form" class="contact_form">
								<div class="row">
									<div class="col-xl-6">
										<!-- Name -->
										<label for="contact_name">Ваше имя*</label>
										<input type="text" name="name1" id="contact_name" class="contact_input" required="required">
									</div>
									<div class="col-xl-6 last_name_col">
										<!-- Last Name -->
										<label for="contact_last_name">Ваш e-mail*</label>
										<input type="email" name="email1" id="contact_last_name" class="contact_input" required="required">
									</div>
								</div>
								<div>
									<!-- Subject -->
									<label for="contact_company">Тема сообщения</label>
									<input type="text" id="contact_company" class="contact_input">
								</div>
								<div>
									<label for="contact_textarea">Ваше сообщение*</label>
									<textarea id="contact_textarea" class="contact_input contact_textarea" required="required"></textarea>
								</div>
								<button type="submit" name="sab" class="button contact_button"><span>ОТПРАВИТЬ</span></button>
							</form>	
				...
				<div class="col-lg-3 offset-xl-1 contact_col">
					<div class="contact_info">
						<div class="contact_info_section">
							...
							<ul>
								<li>Телефон: <span>+7(343) 271-80-60</span></li>
								<li>E-mail: <span>info@kse-plastic.ru</span></li>
							</ul>
						</div>
						<div class="contact_info_section">
							<div class="contact_info_title">ООО "Комплект-Сервис-Екб"</div>
							<ul>
								<li>Адрес: 
									<span><br>Свердловская область, <br>
									город Заречный, ул. Восточная, 11</span></li>								
							</ul>
						</div>
						<div class="contact_info_section">
							...
							<ul>
								...
								<li>Юридический адрес: 
									<span><br> 620142, Свердловская область,<br> 
									город Екатеринбург, <br>
									улица Фурманова, дом 24, оф. 26</span>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="map">
						<div id="google_map" class="google_map">
							<div class="map_container">
								<div id="map">								
							    <div><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2181.6733369264734!2d60.61895871550286!3d56.85154691418259!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x43c16e7f36c283b5%3A0x51bcb36155b2299f!2z0JLQvtGB0YLQvtGH0L3QsNGPINGD0LsuLCAyNCwg0JXQutCw0YLQtdGA0LjQvdCx0YPRgNCzLCDQodCy0LXRgNC00LvQvtCy0YHQutCw0Y8g0L7QsdC7LiwgNjIwMTMz!5e0!3m2!1sru!2sru!4v1678513909868!5m2!1sru!2sru" width="750" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
							</div>
							</div>
						</div>
					</div>
